...
client.on("message", async message => {
  ...
  if (reklamkick == "Açık") {
    ...
    const reklam2 = ["am","it","oc","çoc","azdır","amı","piç","anan","anal","sik","mk"]   
