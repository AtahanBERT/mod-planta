...
message.react('✅')
  ...
  message.channel.send(new Discord.MessageEmbed().setColor("0x800d0d").setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setTimestamp().setDescription(`${basarisiz} ${message.author}, Kullanıcıyı bulamadım!`));
  return;
}
